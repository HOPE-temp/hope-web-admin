...
export const schema = z
  .object({
    title: z
      ...
      .regex(/^[a-zA-ZÀ-ÿ0-9\s\-_.,!?]+$/, "El título contiene caracteres no válidos"),
    resourceUrl: z
      .string()
      .refine(
        (value) => {
        ...
        { message: "Debe ser una URL válida (ejemplo: https://ejemplo.com)" }
      )
      .optional()
      .or(z.literal("")),
    scheduleStartAt: z
  ...
  .refine(
    ...
    {
      message: "Debe especificar una fecha de inicio si especifica una fecha de fin",
