...
import { checkupScheduleFollowup } from '@/services/hopeBackend/followups';
...
type CheckupFollowupDialogProps = {
...
export function CheckupFollowupDialog({
  followup,
  onCheckup,
}: CheckupFollowupDialogProps) {
  const { axios } = useAuth();
  ...
  const onSubmit = async ({
    ...
    const adoption = await checkupScheduleFollowup(axios, followup.id, {
      scheduleStartAt,
      scheduleEndAt,
    });
