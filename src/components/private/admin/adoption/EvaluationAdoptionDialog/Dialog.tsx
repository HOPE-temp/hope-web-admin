...
import { evaluationAdoption } from '@/services/hopeBackend/adoptions';
...
export function EvaluationAdoptionDialog({ adoption, onUpdated }: Props) {
  const { axios } = useAuth();
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      await evaluationAdoption(axios, adoption.id, data);
