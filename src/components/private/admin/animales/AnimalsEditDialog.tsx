...
export function AnimalsEditDialog({ animal, updateAnimal, uploadImage }: Props) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      sex: (['male', 'female'].includes(animal.sex as string) ? animal.sex : 'female') as
        | 'male'
        | 'female',
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Modifica los datos del animal y guarda los cambios.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
